        ...
        <div style="text-align:-webkit-center;">
            <div class="user-profile">
                ...
                <ion-avatar style="height:100px; width:100px;">
                    <ion-img :src="delivery.image ? delivery.image : ($store.getters.user.image ? 'http://3.144.168.4/storage/' + $store.getters.user.image :'/assets/img/no-image.png')" @click="takePhoto"></ion-img>
                </ion-avatar>
                <ion-item>
